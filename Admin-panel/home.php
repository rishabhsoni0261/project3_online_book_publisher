<?php
    ...
    $count="select publisher_id from publisher";
    $count1=mysqli_query($connection,$count);
    $count2=mysqli_num_rows($count1);
    
    $user="select * from reader";
    $user1=mysqli_query($connection,$user);
    $user2=mysqli_num_rows($user1);
    
    $book="select * from book as b, category as c, subcategory as sc where b.category_id=c.category_id and b.subcategory_id=sc.subcategory_id";
    $book1=mysqli_query($connection,$book);
    $book2=mysqli_num_rows($book1);
        	...
        	<div class="col-md-3 widget">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      ...
                      <h5><strong><?php echo $user2 ?></strong></h5>
                    </div>
                </div>
        	 </div>
                   
                 <div class="col-md-3 widget" style="margin-left: 30px; width: 280px;">
                <div class="r3_counter_box" >
                    <i class="pull-left fa fa-book dollar2 icon-rounded"></i>
                    <div class="stats">
                      <span>Total Books Published</span>
                      <h5><strong><?php echo $book2 ?></strong></h5>
                    </div>
                </div>
             </div>
		...
		<div class="row-one widgettable" >
			...
			<div class="col-md-3 stat" >
				...
				<div class="col-md-6 top-content">
					<h5>Sales(Membership+Hard Copy)</h5>
					<label>4530</label>
				</div>
		...
		<div class="charts">		
			<div class="mid-content-top charts-grids">
				<div class="middle-content">
						<h4 class="title">Published Books</h4>
					<!-- start content_slider -->
					<div id="owl-demo" class="owl-carousel text-center">
                    <?php
                        while($book3=mysqli_fetch_array($book1))
                        {
                            ?>
                            <div class="item">
                              <a href="http://localhost/reader-panel/bookdetails.php?book_id=<?php echo $book3['book_id'] ?>&&categoryname=<?php echo $book3['category_name'] ?>" target="_blank"> <img class="lazyOwl img-responsive" data-src="../publisher-panel/<?php echo $book3['book_cover_page'] ?>" alt="Image not available" style="height: 500px; width: 400px;"></a>
                            </div>       
                            <?php 
                        }
                    ?>
