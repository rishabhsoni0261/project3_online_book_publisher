...
$count=$ob->select_book();
$count1=mysqli_num_rows($count);
$c=$ob->select_publisher();
                    ...
                    <div class="col-md-6">
                        <div class="welcome-wrap">
                            <div class="welcome-text">
                                <h2 class="section-title">Welcome to ocean of books</h2>
                                <span class="underline left"></span>
                                <p class="lead">Read a thousand books & your words will flow like a river.</p>
                                <p>The project titled "Digital Library Management System" is a website for monitoring and controlling the books electronically.
                                    ...
                                    It features a familiar & well thought-out, an attractive user interface, combined with searching insertion and reporting capabilities.
                                    </p>
                                <a class="btn btn-primary" href="reviews.php">Read More</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <ul>
                                <li class="bg-blue">
                                    <div class="fact-item">
                                        ...
                                        <span>eBooks<strong class="fact-counter"><?php echo $count1 ?></strong></span>
                                    </div>
                                </li>
                                ...
                                <li class="bg-red">
                                    <div class="fact-item">
                                        ...
                                        <span>Publishers<strong class="fact-counter"><?php echo $c1 ?></strong></span>
                                    </div>
                                </li>
        ...
        <section class="category-filter section-padding">
            <div class="container">
                    ...
                    <div class="filter btn" data-filter="all">All Releases</div>
                        ...
                        <?php
                            while($select1=mysqli_fetch_array($select))
                            {
                                    ...
                                    <img src="../publisher-panel/<?php echo $select1['book_cover_page'] ?>" style="height: 400px; width: 350px;" alt="New Releaase">
                            
                            <figcaption class="bg-orange">
                                <div class="info-block">
                                    <h4><?php echo $select1['book_name'] ?></h4>
                                    <span class="author"><strong>Author:</strong><?php echo $select1['book_author_name'] ?></span>
                                    <span class="author"><strong>ISBN:</strong><?php echo $select1['book_ISBN'] ?></span>
                                    <div class="rating">
                                        <span>☆</span>
                                        <span>☆</span>
                                        <span>☆</span>
                                    ...
                                    <a href="bookdetails.php?book_id=<?php echo $select1['book_id'] ?>">Read More <i class="fa fa-long-arrow-right"></i></a>
                                    <ol>
                                        <li>
                                            <a href="#">
                ...
                <?php
                        ...
                        ?>          
                <div class="center-content">
                    <a href="displaybooks.php" class="btn btn-primary">View More</a>
                </div>
